...
-->
  ...
  <body>
	...
	<form  role="form" method="post" action="send_fun.php">
			...
			<div class="container formBG TableMainBlock">
				<div class="col-md-6">
					<div id="TrueWeektable">
						...
						<div class="TableDay">
							<label><input type="checkbox" id="TFriday" name="TFriday" value="disableChekbox" onclick="isMonday('TFriday', 'TFridayFeild', 'TFriday')">&nbsp;Пятница:</label>
