...
$opts['hn'] = 'mysql.hostinger.ru';
$opts['un'] = 'u568080489_admin';
$opts['pw'] = 'qwerty123';
$opts['db'] = 'u568080489_mybd';
$opts['tb'] = 'schedule';
...
$opts['fdd']['ResultGroup_id'] = array(
  'name'     => 'ResultGroup ID',
  'select'   => 'T',
  'maxlen'   => 11,
  'sort'     => true
);
$opts['fdd']['ResultDay_id'] = array(
  'name'     => 'ResultDay ID',
  'select'   => 'T',
  'maxlen'   => 11,
  'sort'     => true
);
$opts['fdd']['type_lesson_id'] = array(
  'name'     => 'Type lesson ID',
  'select'   => 'T',
  'maxlen'   => 11,
  'sort'     => true
);
$opts['fdd']['audience_id'] = array(
  'name'     => 'Audience ID',
  'select'   => 'T',
  'maxlen'   => 11,
  'sort'     => true
);
$opts['fdd']['subject_id'] = array(
  'name'     => 'Subject ID',
  'select'   => 'T',
  'maxlen'   => 11,
  'sort'     => true
);
$opts['fdd']['teacher_id'] = array(
  'name'     => 'Teacher ID',
  'select'   => 'T',
  'maxlen'   => 11,
  'sort'     => true
